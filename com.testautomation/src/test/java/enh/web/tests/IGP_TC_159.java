...
public class IGP_TC_159 extends KeywordUtil{
	String stepInfo="";
	...
	@Test(
			...
			description="Navigation to Checkout page: Ensure that clicking on 'place order' button navigating to Checkout page."
			)
		...
		try{
			...
			*/
			...
			verifyStep(DeliveryPage.verifyDeliveryPageLoaded(),
			 ...
			 stepInfo="Empty cart";
			 logStep(stepInfo);
			 verifyStep(CartPage.emptyCart(),stepInfo);
			 CartPage.closeCartOverlay();
