...
public class IGP_TC_169 extends KeywordUtil{
	String stepInfo="";
	...
	@Test(
			...
			description="Order Summary :Coupon code. (valid) : Ensure that user is able to get the discount on total amount if he had any coupons."
			)
