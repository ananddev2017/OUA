...
public class IGP_TC_170 extends KeywordUtil{
	String stepInfo="";
	...
	@Test(
			...
			description="Order Summary - Coupon code. (invalid): Ensure that user is able to get the discount on total amount if he had any coupons."
			)
	public void test() throws Throwable {
		try{
			...
			*/
			...
			stepInfo="Enter invalid coupen and verify: "+Constants.INVALID_COUPEN;
			logStep(stepInfo);
			OrderSummaryPage.inputCoupenAndApply(Constants.INVALID_COUPEN);
			verifyStep(OrderSummaryPage.verifyCoupenIsInvalid(Constants.VALID_COUPEN), stepInfo);
