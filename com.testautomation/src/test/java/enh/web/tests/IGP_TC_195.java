...
public class IGP_TC_195 extends KeywordUtil{
	String stepInfo="";
	...
	@Test(
			testName="IGP_TC_195",
			groups={"Payment"}, 
			description="Payment page options:Ensure that  if the each listed payment option opens the respective payment option as per specification. "
			)
