...
public class IGP_TC_177 extends KeywordUtil{
	String stepInfo="";
	...
	@Test(
			...
			description="Order Summary - Place Order:Ensure  that when user click on 'Place Order'  it has to navigate to  ‘Payment page’. "
			)
