...
public class IGP_TC_171 extends KeywordUtil{
	String stepInfo="";
	...
	@Test(
			...
			description="Remove product from the Order Summary page:Ensure that user able to remove the  product from the Checkout page through 'Order summary' screen Or not."
			)
	public void test() throws Throwable {
		try{
			...
			*/
			...
			stepInfo="Verify Click on Remove product from cart. Should display a popup message with Remove/Cancel links";
			logStep(stepInfo);
			...
			stepInfo="Verify cancel link should hide popup";
			logStep(stepInfo);
