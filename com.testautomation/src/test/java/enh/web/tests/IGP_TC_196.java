...
public class IGP_TC_196 extends KeywordUtil{
	String stepInfo="";
	...
	@Test(
			testName="IGP_TC_196",
			groups={"Payment"}, 
			description="Payment Page: Ensure  that at header of the Payment page is displaying Total Amount  payable."
			)
	public void test() throws Throwable {
		try{
			...
			*/
			...
			stepInfo="Verify total amount payable is displayed";
			logStep(stepInfo);
			verifyStep(PaymentPage.totalAmountPayableIsDisplayed(),stepInfo);
			logStep("Message text: " + PaymentPage.getTotalAmountPayableLine());
