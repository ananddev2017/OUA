...
public class IGP_TC_160 extends KeywordUtil{
	String stepInfo="";
	...
	@Test(
			...
			description="Login through 'check out' page.Ensure that User should  login to proceed the process in Checkout Page."
			)
