...
public class IGP_TC_174 extends KeywordUtil{
	String stepInfo="";
	...
	@Test(
			...
			description="Product Description Form: Ensure  that Product Description form contains Product Image, Actual Cost, Increase/Decrease quantity, Delivery details and Subtotal."
			)
	public void test() throws Throwable {
		try{
			...
			*/
			...
			stepInfo="Check the product description form";
			
			verifyStep(OrderSummaryPage.IsProductImageDisplayed(), "Verify Product Image is displayed");
			verifyStep(OrderSummaryPage.IsProductActualCostDisplayed(), "Verify Actual cost is displayed");
			verifyStep(OrderSummaryPage.IsIncreaseAndDecraseUIDisplayed(), "Verify Increase/Decrease quantity is displayed");
		
			verifyStep(OrderSummaryPage.IsProductDeliveryDetailsInfoDisplayed(), "Delivery details is displayed");
			verifyStep(OrderSummaryPage.IsProductSubtotalDisplayed(), "Subtotal details is displayed");
			
			verifyStep(true, stepInfo);
