...
public class IGP_TC_165 extends KeywordUtil{
	String stepInfo="";
	...
	@Test(
			...
			description="View message in 'order summary': Ensure that clicking on 'View message' displays a pop-up to enter message."
			)
	public void test() throws Throwable {
		try{
			...
			*/
			...
			stepInfo="Verify enter message pop displayed on clicking-'Enter Message'";
			logStep(stepInfo);
			verifyStep(OrderSummaryPage.verifyEnterMessagePopUp(),stepInfo);
