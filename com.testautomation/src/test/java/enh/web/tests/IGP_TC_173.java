...
public class IGP_TC_173 extends KeywordUtil{
	String stepInfo="";
	...
	@Test(
			...
			description="Total Amount Payable:Ensure  that In Total Amount has to display include: delivery charges + Gift Box charges should be shown  Continue to Payment will be redirected to Payments Page."
			)
	public void test() throws Throwable {
		try{
			...
			*/
			...
			stepInfo="Check the total amount payable";
			logStep(stepInfo);
			logStep("Total amount: " +OrderSummaryPage.getOrderTotalAmount());
			verifyStep (!OrderSummaryPage.getOrderTotalAmount().isEmpty(),stepInfo);
