...
public class IGP_TC_166 extends KeywordUtil{
	String stepInfo="";
	...
	@Test(
			...
			description="Delivery information: 'Delete address':Ensure that clicking on 'Delete' icon deletes the address permanently."
			)
	public void test() throws Throwable {
		try{
			...
			*/
			...
			stepInfo="Delete delivery address";
			logStep(stepInfo);
			verifyStep(DeliveryPage.deleteDeliveryAddress(),stepInfo);
			...
			//Add address again
			 ...
			 DeliveryPage.addNewAddress(Constants.NAME,Constants.ADDRESS,Constants.COUNTRY,Constants.PINCODE,Constants.MOBILE);
			 pause(3000);
