...
public class CustomSuiteRunner {
	...
	public static void suiteRunner() {
		 ...
		 * ======================================================================
		 * 
		 *		PROCESS - 1 Get information from Automation Control Sheet file
		 *	---------------------------------------------------------------------
		 *	
		...
		for (TestConfig tc : listOfTestConfigs)
		{
			...
			XmlPackage xmlpkg = new XmlPackage("enh.web.tests");
			...
			//Set all valid execution classes to test 
		...
		//To Run TestNG XML Suites
		
		TestNG testNgRun = new TestNG();
		//Set suites to execute
